...
## 5. 新用户奖励 (10%, 限10,000名额)
注册即参与，完成三个任务可获最多 200 AWT，30天线性释放：

| 任务 | 条件 | 奖励 |
|------|------|------|
| 注册 | 创建 AlgoWhirl 账号 | 50 AWT |
| 存款 | 存入 $10+ 到交易账户 | 50 AWT |
| 交易 | 注册后7天内完成 $100+ 交易量 | 100 AWT |
...
## 8. 合约地址 (Base Mainnet, Chain ID: 8453)
...
| MiningRewardsVault | `0xc39671f9E269D307A57fE615C2eAB3AA3f11C62A` | 交易挖矿 500M AWT |
...
| ReferralVault | `0xac0a09b6E804d4eA10dB8121dad87f4b52F46de9` | 推荐奖励 10% |
| NewUserVault | `0x49B1fdd96a4b9A7f351a37dC44b2E4082685fadf` | 新用户奖励 10% |
